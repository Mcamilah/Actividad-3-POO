...
package gui;
import ejercicio22.Calculo;

public class pantallasalario extends javax.swing.JFrame {

    
    public pantallasalario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ingrese el salario por hora:");

        Respuesta.setBackground(new java.awt.Color(153, 153, 255));
    ...
    private void RespuestaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RespuestaActionPerformed
        String Nombre, Horas, Salariohora, Total;
        double salhor;
        int hor;
        Nombre=nombre.getText();
        Horas=horas.getText();
        Salariohora=salario.getText();
        hor=Integer.parseInt(Horas);
        salhor=Double.parseDouble(Salariohora);
        Total=Calculo.Calculo(Nombre, salhor, hor);
        total.setText(Total);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pantallasalario().setVisible(true);
            }
        });
    }
